...
//        System.out.println("map = " + map);
        ...
        for (String s : record) {
            ...
            if ("Enter".equals(s1[0])) {
                temp = map.get(s1[1]) + "님이 들어왔습니다."; // uid
                list.add(temp);
            } else if("Leave".equals(s1[0])) {
                temp = map.get(s1[1]) + "님이 나갔습니다.";
                list.add(temp);
            }
        }
...
//        System.out.println("list = " + list);
     ...
     public static void main(String[] args) {
         ...
         String[] solution = openChat.solution(new String[]{
